...
class Edificio_I extends StatefulWidget {
  const Edificio_I({Key? key}) : super(key: key);

  @override
  State<Edificio_I> createState() => _AulasState();
}

class _AulasState extends State<Edificio_I> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edificio I', style: TextStyle(color: Colors.white)),
