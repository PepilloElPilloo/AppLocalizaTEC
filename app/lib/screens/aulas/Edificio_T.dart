...
class Edificio_T extends StatefulWidget {
  const Edificio_T({Key? key}) : super(key: key);

  @override
  State<Edificio_T> createState() => _AulasState();
}

class _AulasState extends State<Edificio_T> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edificio T', style: TextStyle(color: Colors.white)),
