...
class Edificio_J extends StatefulWidget {
  const Edificio_J({Key? key}) : super(key: key);

  @override
  State<Edificio_J> createState() => _AulasState();
}

class _AulasState extends State<Edificio_J> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edificio J', style: TextStyle(color: Colors.white)),
