...
class Edificio_O extends StatefulWidget {
  const Edificio_O({Key? key}) : super(key: key);

  @override
  State<Edificio_O> createState() => _AulasState();
}

class _AulasState extends State<Edificio_O> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edificio O', style: TextStyle(color: Colors.white)),
