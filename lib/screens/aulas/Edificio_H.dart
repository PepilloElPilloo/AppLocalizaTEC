...
class Edificio_H extends StatefulWidget {
  const Edificio_H({Key? key}) : super(key: key);

  @override
  State<Edificio_H> createState() => _AulasState();
}

class _AulasState extends State<Edificio_H> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
        title: const Text('Edificio H', style: TextStyle(color: Colors.white)),
