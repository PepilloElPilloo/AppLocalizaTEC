...
class Edificio_Y extends StatefulWidget {
  const Edificio_Y({Key? key}) : super(key: key);

  @override
  State<Edificio_Y> createState() => _AulasState();
}

class _AulasState extends State<Edificio_Y> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edificio Y', style: TextStyle(color: Colors.white)),
