...
class Edificio_K extends StatefulWidget {
  const Edificio_K({Key? key}) : super(key: key);

  @override
  State<Edificio_K> createState() => _AulasState();
}

class _AulasState extends State<Edificio_K> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edificio K', style: TextStyle(color: Colors.white)),
